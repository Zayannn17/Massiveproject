            ...
            <Carousel interval={null} pause={false}>
              <Carousel.Item className=" ">
                <div className="carousel-row d-flex justify-content-center align-items-center ">
                  <div className="carousel-element  ">
                    "Rendi adalah pemandu yang luar biasa! Pengalaman kami di
                    Ketapang sangat berkesan berkat panduan dan
                    keramahannya."
                  </div>
                  <div className="carousel-element">
                    {" "}
                    "Kami sangat puas dengan layanan Rendi. Dia memberikan wawasan
                    yang mendalam tentang destinasi kami dan selalu siap
                    membantu."
                  </div>
                  <div className="carousel-element">
                    {" "}
                    "Rendi, pemandu kami di Ketapang, adalah sosok luar biasa!
              ...
              <Carousel.Item>
                <div className="carousel-row ">
                  <div className="carousel-element">
                    "Kami sangat beruntung memilih Rendi sebagai tour guide kami
                  </div>
                  <div className="carousel-element">
                    {" "}
                    "Dengan Rendi sebagai pemandu kami, kami merasa yakin dan
                    nyaman menjelajahi destinasi yang belum kami kunjungi
                    sebelumnya. Terima kasih, Rendi, atas pengalaman wisata yang
                    luar biasa!"
                  </div>
                  <div className="carousel-element">
                    {" "}
                    "Rendi memberikan layanan yang sangat baik kepada kami. Dia
                    sangat responsif dan selalu siap membantu. Kami pasti akan
                    merekomendasikan Rendi kepada teman-teman kami."
                  </div>
                </div>
              </Carousel.Item>
            </Carousel>
