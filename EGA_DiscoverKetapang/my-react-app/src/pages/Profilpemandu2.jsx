            ...
            <Carousel interval={null} pause={false}>
              <Carousel.Item className=" ">
                <div className="carousel-row d-flex justify-content-center align-items-center ">
                  <div className="carousel-element  ">
                    "Okta adalah pemandu yang sangat berpengetahuan tentang
                    sejarah dan budaya Ketapang. Dia membuat setiap tempat yang
                    kami kunjungi menjadi hidup."
                  </div>
                  <div className="carousel-element">
                    {" "}
                    "Kami sangat senang dengan pelayanan Okta selama perjalanan
                    kami. Dia memberikan panduan yang informatif dan memberikan
                    wawasan tentang budaya setempat."
                  </div>
                  <div className="carousel-element">
                    {" "}
                    "Kami sangat beruntung memiliki Okta sebagai pemandu kami di
                    Ketapang. Okta memiliki pengetahuan sejarah yang luar biasa,
                    dan dia sangat baik dalam menjelaskan tempat-tempat yang
                    kami kunjungi."
                  </div>
                </div>
              </Carousel.Item>
              <Carousel.Item>
                <div className="carousel-row ">
                  <div className="carousel-element">
                    "Okta adalah pemandu yang sangat ramah, dan kami merasa
                    seperti dia adalah teman selama perjalanan kami di Ketapang.
                    Kami tak sabar untuk menjalani petualangan lain bersamanya."
                  </div>
                  <div className="carousel-element">
                    {" "}
                    "Okta membantu kami menjelajahi keindahan alam dan budaya
                    Ketapang. Kunjungan kami akan selalu dikenang berkat panduan
                    yang luar biasa ini."
                  </div>
                  <div className="carousel-element">
                    {" "}
                    "Kami sangat puas dengan perjalanan bersama Okta. Dia adalah
