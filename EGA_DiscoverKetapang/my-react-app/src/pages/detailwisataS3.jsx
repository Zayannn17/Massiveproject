...
import pic1 from "../../src/assets/img/RAD.png";
          ...
          >
            <div className="detail-box">
              ...
              <div className="detail-header">
                <div>
                  <h1 className="text-light">Rumah Adat Dayak</h1>
                </div>
              ...
              <div className="detail-text">
                <p>
                  Rumah bernuansa adat Melayu yang dikenal sebagai Balai Kyai
                  Mangku Negeri Ketapang atau Rumah Melayu Kepala Pulau, juga
                  sering disebut sebagai Rumah Adat Melayu Kyai Mangku Ketapang,
                  merupakan sebuah landmark yang menarik di Kota Ketapang,
                  Kalimantan Barat. Berlokasi di tepian Sungai Pawan, rumah adat
                  ini menjadi daya tarik bagi warga setempat dan pengunjung yang
                  ingin mengenal lebih dekat budaya Melayu di daerah tersebut.
                </p>
                <p>
                  Meskipun masih dalam tahap pengembangan, rumah adat ini
                  memberikan kesempatan bagi warga setempat untuk melihat dan
                  mengapresiasi keindahan arsitektur dan nilai-nilai budaya yang
                  terkandung di dalamnya. Terletak di Kelurahan Mulia Baru,
                  Kecamatan Delta Pawan, rumah adat ini dapat dijangkau dengan
                  mudah dari pusat kota Ketapang, hanya sekitar 10 menit
                  perjalanan menggunakan kendaraan bermotor.
                </p>
                <p>
                  Rumah Adat Melayu Kyai Mangku Ketapang terdiri dari tiga
                  bangunan utama, termasuk bangunan induk yang berukuran besar,
                  Balai Rung Sari, dan Balai Peranginan. Dengan luas bangunan
                  mencapai 2 hektar, rumah adat ini menjadi saksi bisu sejarah
                  perkembangan kebudayaan Melayu di Kalimantan Barat. Sejak
                  pendeklarasiannya pada 29 Mei 2009, rumah adat ini telah
                  menjadi pusat pelestarian dan pembelajaran budaya Melayu,
                  serta tujuan wisata yang menarik di Kota Ketapang.
                </p>
                <p>
                  Sayangnya, saat ini Rumah Adat Melayu Ketapang mungkin
                  mengalami tantangan dalam pemeliharaan, yang dapat memengaruhi
                  daya tarik dan kenyamanan pengunjung. Namun, harapannya adalah
                  upaya pelestarian akan terus dilakukan agar keunikan dan
                  keindahan rumah adat ini tetap dapat dinikmati oleh generasi
                  mendatang.
                </p>
              </div>
              <div
